...
import time, re
import os 
os.environ['http_proxy']='http://vip-users.proxy.edf.fr:3128'
os.environ['https_proxy']='http://vip-users.proxy.edf.fr:3128'
os.environ['ftp_proxy']='http://vip-users.proxy.edf.fr:3128'
os.environ['no_proxy']='.edf.fr'
...
class TextDataset(object):
    ...
    def embed(self, filename=None, size=100):
        ...
        if filename:
            ...
            # Classe interne pour itérer sur les documents
            ...
            # Créer un modèle Word2Vec à partir des documents
        ...
        # Remplir les embeddings avec les vecteurs du modèle
        ...
        print('{} words not found in corpus'.format(not_found))
        self.keep_words(keep)

class Text20News(TextDataset):
    def __init__(self, **params):
        dataset = fetch_20newsgroups(**params)
